...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(createMenu().consumption).toEqual(['Pizza']);
    ...
    expect(createMenu().consumption).toEqual(["Pizza", "coxinha", "agua", "sopa", "sashimi"]);
    // function menuOrder() {
    //   const foods = ['coxinha', 'agua', 'sopa', 'sashimi'];
    //   let pedidos = createMenu().consumption;
    //   for (let index = 0; index < foods.length; index += 1) {
    //     let change = createMenu().order(foods[index]).join()
    //     pedidos.push(change);
    //   }
    //   return pedidos;
    // }
    // expect(menuOrder()).toEqual(["coxinha", "agua", "sopa", "sashimi"]);
    ...
    createMenu().order('agua');
    createMenu().order('coxinha');
    expect(createMenu().consumption).toEqual(["Pizza", "coxinha", "agua", "sopa", "sashimi", "coxinha", "agua", "coxinha"]);
    ...
    expect(createMenu(menu).pay()).toBe(111.1);
